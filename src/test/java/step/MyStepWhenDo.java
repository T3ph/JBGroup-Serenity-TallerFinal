...
public class MyStepWhenDo {
    ...
    public void stephHaveAccessToWhenDoApp(Actor actor) {
    }

    @When("{actor} creates a new task")
    public void sheCreatesANewTask(Actor actor, Map<String,String> data) {
    ...
    public void sheExpectedTheTaskShouldBeCreated(Actor actor, String expectedResult) {
        actor.should(
    ...
    public void sheEditTheNewTask(Actor actor, Map<String, String> data) {
    ...
    public void sheExpectedTheTaskShouldBeEdited(Actor actor, String expectedResult) {
        actor.should(
